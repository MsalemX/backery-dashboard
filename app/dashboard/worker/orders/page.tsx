  ...
  return (
    <div className="p-8 pb-20 bg-[#f9fafb] min-h-screen font-sans">
      <div className="mb-10 text-right">
        <h1 className="text-4xl font-black text-gray-800 tracking-tight">طلبات الزبائن</h1>
        <p className="text-gray-500 mt-2 font-medium">قائمة الطلبات الجديدة للتجهيز والتوصيل</p>
      </div>
                      ...
                      {order.order_status === 'pending' && (
                        <>
                          <button
                            ...
                            className="bg-emerald-700 text-white px-5 py-2.5 rounded-xl font-bold text-xs hover:bg-emerald-800 transition-all shadow-lg shadow-emerald-900/10"
                          >
                            تم التوصيل
                          </button>
                          <button
                             onClick={() => handlePaymentUpdate(order.id, 'paid')}
                             className="bg-white border border-gray-200 text-gray-700 px-5 py-2.5 rounded-xl font-bold text-xs hover:bg-gray-50 transition-all"
                          >
                             استلمت المبلغ
                          </button>
                        </>
