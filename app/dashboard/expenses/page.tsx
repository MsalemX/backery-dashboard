...
export default function ExpensesPage() {
  ...
  const [expenses, setExpenses] = useState([
    { id: 1, category: "مواد خام", amount: 2500, description: "شراء 50 كيس طحين فاخر", date: "2024/08/08" },
    { id: 2, category: "كهرباء ومياه", amount: 1200, description: "فاتورة الكهرباء شهر 7", date: "2024/08/05" },
    { id: 3, category: "رواتب", amount: 8000, description: "رواتب الموظفين - أسبوع 1", date: "2024/08/01" },
    { id: 4, category: "وقود", amount: 450, description: "سولار للمولد الكهربائي", date: "2024/08/07" },
    { id: 5, category: "صيانة", amount: 300, description: "تصليح سير العجانة", date: "2024/08/06" },
  ]);
      ...
      <main className="flex-1 mr-64 p-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
           <div className="bg-white p-8 rounded-[40px] border border-gray-100 shadow-sm">
              <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">إجمالي مصروفات الشهر</p>
           ...
           <div className="bg-white p-8 rounded-[40px] border border-gray-100 shadow-sm">
              ...
              <h2 className="text-4xl font-black text-amber-800">الرواتب</h2>
           </div>

           <div className="bg-white p-8 rounded-[40px] border border-gray-100 shadow-sm">
              <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">عدد العمليات هذا الشهر</p>
                       ...
                       <tr key={exp.id} className="group hover:bg-gray-50/50 transition-colors">
                          ...
                          <td className="px-8 py-6">
                             <div className="flex justify-center">
                                <button className="p-2 text-gray-300 hover:text-rose-600 transition-colors rounded-lg hover:bg-rose-50 group/del">
